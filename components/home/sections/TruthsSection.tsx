  ...
  return (
    <section className="py-20 sm:py-28 bg-[#faf9f6] dark:bg-background-dark border-t border-accent-gold/10">
        ...
        <div className="flex items-end justify-between mb-10">
          <div>
            <motion.h2
              ...
              viewport={{ once: true }}
              className="text-4xl sm:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white font-kufi"
            >
              حقائق
            </motion.h2>
            <p className="text-gray-500 dark:text-gray-400 font-amiri text-lg mt-3 max-w-2xl">
              خلاصات التجارب الذوقية والمعارف اللدنية، كشوفات أهل الله وأسرارهم.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative">
        ...
        <div
          ref={scrollRef}
          className="flex gap-6 lg:gap-8 overflow-x-auto snap-x snap-mandatory scrollbar-hide pb-4 px-4 sm:px-6 lg:pr-12 lg:pl-[max(1rem,calc((100vw-80rem)/2+3rem))]"
        ...
        >
          ...
          <motion.article
            ...
            viewport={{ once: true }}
            variants={fadeUp}
            className="group flex-shrink-0 w-[85vw] sm:w-[45vw] lg:w-[30vw] xl:w-[26vw] snap-start"
          >
            <Link href={`/ar/truths/${article.slug_ar}`} className="block">
              <div className="aspect-video mb-5 overflow-hidden relative">
                {article.coverImage ? (
                  <CoverImage
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white font-kufi mb-2">
                {article.title_ar}
              </h3>
              <p className="text-gray-500 dark:text-gray-400 line-clamp-2 text-sm font-amiri leading-relaxed">
                {article.excerpt_ar}
              </p>
            </Link>
          </motion.article>
